...
simfunc = theano.function(inputs=[wb,k,M,beta,g,erase,add], outputs=[sim,weight_c,weight,memory_erase,memory])
...
print simfunc(wbt,kt, Mt,betat,gt,eraset,addt)
...
simfunc = theano.function(inputs=[wb,k,M,beta,g,erase,add], outputs=[sim,bt,weight_c,weight_g,M_erase,memory])
